...
#Ver 07 - simplify feeding - just give all flesh to brood rather than in increments if it's available
#Ver 08 - so with just feeding flesh, larvae aren't getting enough to consistently make it to adulthood (survival should be relativley high, 94.4%?)
    #Nutritional oophagy - use queen egg-laying rate and oophagy rate (Mead et al. 1994) to get brood to hunger threshould
    #this will also free up nest space for more eggs/brood, nest size should get/stay smaller
    #FOR FEEDING AS PART OF MODEL GO BACK TO VERSION 08
#Ver 09 - simplifying everything again - taking out feeding, just using larval mortality rates from Mead et al. 1994
...
class Brood(object):
 ...
 #       self.mortality_risk = randint(7, 61) #integer form of mortality rate of 7-61% (from Mead et al. 1994, avg. = 27), too high!
        self.mortality_risk = 2 #avg from Mead et al. 1994, way too high for a daily rate, so divide by #days as larvae?
