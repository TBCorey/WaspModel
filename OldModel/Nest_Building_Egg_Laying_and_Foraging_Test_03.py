...
queen = Queen(0, "build", "mass", "death_date", "alive") #can build in haplometrosis eventually by having two queens, queen_a and queen_b, called via a random number generator based on frequency of multiple foundress nesting
