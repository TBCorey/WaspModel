...
#Ver 05 - hunger threshold and death, but taking out hunger function, no cannibalism yet, but changing to age rather than hunger-related

###Check Nest_Building_Egg_Laying_and_Foraging_Test_07 for updated code that had been based off of this test (and changed a lot, simplified in some ways)
from random import randint, choice, uniform

class Nest(object):#changes to this are made in the conglomerated file egg_laying_and_foraging_test
...
#So should the assumption be mass of a worker is 73% of the food given (that still winds up being a pretty huge amount of food)
    #or does it? If max payload is 0.0173 and 0.014, and weight is 0.1, then that's about the same # of prey balls
    #keep getting this 8-9 range, guess things are alright
