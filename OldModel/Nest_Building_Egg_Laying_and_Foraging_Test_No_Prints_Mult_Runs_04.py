...
with open("Wasp_Output_Test_10.csv", mode = "w") as file:#started at Wasp_Output_Test_04 for mortality = 2
    kills = []
    nest_sizes = []
    queen_build_rates = []
    queen_ages = []
 ...
 #       print("Final cell count:", nest.total_cell_count)
    ...
    file.write("Kills,Nest Size,Build Rate,Queen Age\n")
    for i in range(len(kills)):
        file.write(str(kills[i]) + "," + str(nest_sizes[i]) + "," + str(queen_build_rates[i]) + "," + str(queen_ages[i]) + "\n")
