#How to represent the nest in the model #Ver 04 - feedback from Matt (1.27.14)
...
class Queen(object):
    ...
    mass_options = round(uniform(0.086, 0.114), 3)
    ...
    def __init__(self, age, build_rate, mass):
        ...
        self.mass = self.mass_options #important to compare to usurper, mean = 0.10 g +/- SE 0.002g, n = 48, so SD is +/- 0.014
...
class Brood(object):
    def __init__(age,food_need, dev_stage, alive):
        self.age = age
