...
with open("Wasp_Output_Test_05.csv", mode = "w") as file:
    kills = []
    nest_sizes = []
    queen_build_rates = []
    queen_ages = []
    ...
    for i in range(2000):
        ...
        class Brood(object):
         ...
         #       self.mortality_risk = randint(7, 61) #integer form of mortality rate of 7-61% (from Mead et al. 1994, avg. = 27), too high!
                self.mortality_risk = 3#start at 2 #avg from Mead et al. 1994, way too high for a daily rate, so divide by #days as larvae? go up from here
