...
#Ver 04 - change payload capacity to dry weight of flesh pellets from Suzuki 1980 (0.0031g for foundress, 0.0033g for worker)
    #Interesting thing to look at! Tweaks with Matt <3
...
def main():
    global day_count, total_caterpillars_killed, total_flesh_gathered, nest, queen
    while day_count < 10:
        ...
        if len(nest.worker_list) == 0 and queen.status == "alive": #if there are no workers and the queen's alive, she forages
            ...
            flesh_gathered_today = caterpillars_killed_today*0.0031 #0.0031 is avg. flesh pellet dry weight (Suzuki 1980)
            ...
            flesh_gathered_today = caterpillars_killed_today*0.0033 #0.0033 is avg. flesh pellet dry weight for workers (Suzuki 1980)
